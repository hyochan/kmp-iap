---
slug: release-1.1.0
title: 1.1.0 - Billing Programs API & One-Time Product Discounts
authors: [hyochan]
tags: [release, android, google-play-billing, billing-programs, discounts, breaking-change]
description: KMP-IAP 1.1.0 brings Google Play Billing Library 8.2.0 features including the new Billing Programs API for external billing and one-time product discount support.
date: 2025-12-16
---

# KMP-IAP 1.1.0

KMP-IAP 1.1.0 brings **Google Play Billing Library 8.2.0** features including the new **Billing Programs API** for external billing and **one-time product discount support** from Billing Library 7.0+.
...
```kotlin
// Platform-specific verification options (NEW in 1.1.0)
...
- `openiap-apple`: [1.3.0 -> 1.3.5](https://github.com/hyodotdev/openiap/compare/apple-v1.3.0...apple-v1.3.5)
- `openiap-google`: [1.3.10 -> 1.3.14](https://github.com/hyodotdev/openiap/compare/google-v1.3.10...google-v1.3.14)
- `openiap-gql`: [1.3.0 -> 1.3.5](https://github.com/hyodotdev/openiap/compare/1.3.0...1.3.5)
