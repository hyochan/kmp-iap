---
slug: release-1.0.0
title: Release 1.0.0 - Built-in Purchase Verification (aka Receipt Validation)
authors: [hyochan]
...
KMP-IAP 1.0.0 brings **built-in purchase verification** (aka receipt validation) powered by [IAPKit](https://iapkit.com). Now you can verify purchases with enterprise-grade backend validation using a single API call-no server setup required.
